...
\def\papertitle{Simple Room Air Ventilation Control System Using Internet-of-Things and Machine Learning}
\def\authoronename{Jeane Erwansyah}
\def\authoroneemail{13519116@std.stei.itb.ac.id}
\def\authortwoname{Jeremia Bachtera}
\def\authortwoemail{13519188@std.stei.itb.ac.id}
\def\authorthreename{Josep Marcello}
\def\authorthreeemail{13519164@std.stei.itb.ac.id}
